...
test('landing page contains the Evento Globolo event operations story', () => {
  assert.match(fallback, /id="route"/);
  assert.match(fallback, /id="operations"/);
  assert.match(fallback, /Evento Globolo/);
